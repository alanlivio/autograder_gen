...
class Engine:
    ...
    def __init__(
        self,
        config: Config,
        original_config_dict: Optional[dict] = None,
        ...
        Args:
            ...
            base_dir: Optional base directory for locating extra files (defaults to current working directory)
        """
        self.config = config
...
- **Required Files**: {', '.join(self.config.required_files) if self.config.required_files else 'None specified'}
